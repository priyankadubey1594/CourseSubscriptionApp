...
$query = "ccreate table subscriptions(id int AUTO_INCREMENT PRIMARY KEY, studentId int, courseId int ,subscribedOn datetime, FOREIGN Key (studentId) REFERENCES students(`id`) on DELETE set null on update CASCADE, foreign Key (courseId) REFERENCES courses(`id`) on delete set null on update cascade)";
?>